...
import type { IAdminAuthController, RequestWithAdmin } from './interfaces/admin-auth.controller.interface.js';
import type { IAdminAuthService } from '../services/interfaces/admin-auth.service.interface.js';
